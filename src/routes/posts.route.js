...
import { commentPost, createPost, deletePost, getPosts, getPostsFromUser, getShares, likePost, sharePost, unlikePost, updatePost } from '../controllers/posts.controller.js';
...
postsRouter.post('/shares', userAuth, findPost, sharePost);
postsRouter.get('/shares', userAuth, getShares);
